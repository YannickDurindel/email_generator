...
for i in range(20,30):       #de 0 à 20 done
...
for i in range(len(email)):
    line = {'First Name':str(PRENOMS[i]),'Last Name':str(NOMS[i]),'Email':str(email[2*i]),'Accepts Email Marketing':'','Company':'','Address1':'','Address2':'','City':'','Province':'','Province code':'','Country':'','Country code':'','Zip':'','Phone':'','Accepts SMS Marketing':'','Total Spent':'','Total Orders':'','Tags':'','Note':'','Tax Exempt':''}
    data.writerows(line)
